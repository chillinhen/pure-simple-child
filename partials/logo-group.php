			...
			<?php elseif ( get_bloginfo( 'description' ) || get_bloginfo( 'title' ) ) : ?>
				...
				<div class="site-info fade-logo" style="background-color: <?php echo get_theme_mod( 'site_infobg', '#fff' ); ?>;">
					...
					<?php if ( get_bloginfo( 'title' ) ) { ?>
						<h3 class="site-tagline" style="font-size: <?php echo get_theme_mod( 'site_taglinesize', '1.375rem' ); ?>; color: <?php echo get_theme_mod( 'tagline_colour', '#b9b9b9' ); ?>;"><?php echo esc_attr( get_bloginfo( 'title' ) ); ?></h3>
					<?php } ?>							
				</div>
